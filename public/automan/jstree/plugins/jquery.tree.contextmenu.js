	...
	$.extend($.tree.plugins, {
		"contextmenu" : {
			...
			show : function(obj, t) {
				...
				if (r == -1) $.tree.plugins.contextmenu.object.attr("class","").html(str);
				else $.tree.plugins.contextmenu.object.attr("class","tree-context tree-" + t.settings.ui.theme_name.toString() + "-context").html(str);
